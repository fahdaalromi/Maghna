...
class HomeScreen extends Component {
    ...
    firebase
      ...
      .once("value", (snapshot) => {
        snapshot.forEach((item) => {
          ...
          var statusR;
          if (
            userRoutineArr.indexOf(routineLeave) != -1 ||
            userRoutineArr.indexOf(routineCome) != -1 ||
            userRoutineArr.indexOf(routineMornig) != -1 ||
            userRoutineArr.indexOf(routineNight) != -1
          ) {
            console.log("Trueee");
            firebase
              .database()
  ...
  async componentDidMount() {
    ...
    this.props.navigation.setParams({
      headerLeft: (
        <TouchableOpacity onPress={this.handelSignOut}>
          <SimpleLineIcons
            name="logout"
            size={24}
            color="white"
...
if(snap.val().isActive)
{
  ...
  _toggleSwitch(toggleIndex) {
  
    this.props.dispatch({ type: "TOGGLE", index: toggleIndex });
  
  }

  render() {
    const { isRecording, transcript, isFetching } = this.state;
    const { toggle1, toggle2, toggle3, toggle4 } = this.props.homeSwitches;
    ...
    return (
      ...
      >
        ...
        <TouchableOpacity
          onPress={() => this._toggleSwitch("toggle1")}
          style={{
            fontSize: 25,
            backgroundColor: toggle1 ? "white" : "#6FA0AF",
            color: "#6FA0AF",
            justifyContent: "center",
            width: 150,
            height: 140,
        ...
        <TouchableOpacity
          onPress={() => this._toggleSwitch("toggle2")}
          style={{
            fontSize: 25,
            backgroundColor: toggle2 ? "white" : "#6FA0AF",
            color: "#6FA0AF",
            justifyContent: "center",
            width: 150,
            height: 140,
        ...
        <TouchableOpacity
          onPress={() => this._toggleSwitch("toggle3")}
          style={{
            fontSize: 25,
            backgroundColor: toggle3 ? "white" : "#6FA0AF",
            color: "#6FA0AF",
            justifyContent: "center",
            width: 150,
            height: 140,
        ...
        <TouchableOpacity
          onPress={() => this._toggleSwitch("toggle4")}
          style={{
            fontSize: 25,
            backgroundColor: toggle4 ? "white" : "#6FA0AF",
            color: "#6FA0AF",
            justifyContent: "center",
            width: 150,
            height: 140,
...
/**
 * Exporting with redux
 */
export default connect((state) => ({ homeSwitches: state.homeSwitches }))(
  HomeScreen
);
